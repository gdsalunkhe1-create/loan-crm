...
function subtractMinutes(value, mins) {
 ...
 */
function formatIST(value, format = 'datetime') {
  const canonical = parseIST(value)
  if (!canonical) return '—'
  const parts = splitCanonical(canonical)
 ...
 */
function buildIST(dateStr, timeStr) {
...
export { IST_TZ, nowIST, parseIST, formatIST, addMinutes, subtractMinutes, compareIST, buildIST, toDbTimestamp }
